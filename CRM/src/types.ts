...
export interface AuthUser {
  ...
  avatar?: string;
  wishlist?: string[];
  role: 'user' | 'admin' | 'staff';  // Set in MongoDB — admin sees different UI
  /** Only meaningful for role "staff": which AdminView sections they may access. */
  permissions?: string[];
  phone?: string;
  photoURL?: string;
  gender?: string;
...
export type AuthTab = 'login' | 'register' | 'phone' | 'forgot' | 'success' | 'admin-login' | 'admin-register';
