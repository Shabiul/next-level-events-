...
const OCCASION_IMAGE_OVERRIDES: Record<string, string> = {
  'Simple wall decors': '/SIMPLE WALL FOR HOME PAGE.jpg',
  'Event Packages': '/explore2.jpg',
  'Birthday': '/BIRTHDAY FOR HOME PAGE.jpg',
  'Baby Shower': '/BABY SHOWER FOR HOME PAGE.jpg',
  '1st Birthday': '/1ST BIRTHDAY FOR HOME PAGE.jpg',
  'Welcome Baby': '/WELCOME FOR HOME PAGE.jpg',
  'Anniversary Celebrations': '/ANNIVERSAY FOR HOME PAGE.jpg',
  'Pre & Post Wedding decors': '/PRE AND POST WEDDING FOR HOME PAGE.jpg',
  'Naming ceremony': '/NAMING  FOR HOME PAGE.jpg',
};
