...
const ACTIVITIES_FALLBACK_MAP: Record<string, AdminProduct[]> = {
  ...
  'proposal setup': [
    {
      ...
      image: '/terrace propsal set up.jpg',
      moreImages: ['/terrace propsal set up 3.jpg', '/terrace propsal set up 4.jpg', '/terrace propsal set up 5.jpg', '/terrace propsal set up 6.jpg', '/terrace-proposal.jpg', '/terrace.jpg'],
    ...
    ...(['/proposal set up.jpg', '/proposal set up 1.jpg', '/proposal set up 2.jpg', '/proposal set up 3.jpg', '/proposal set up 4.jpg', '/proposal set up 5.jpg', '/propsal set up 6.jpg', '/propsal set up 7.jpg'].map((img, i) => ({
      _id: `exp_prop_${i + 2}`,
      categoryId: 'cat_exp',
    ...
    ...((['/terrace propsal set up.jpg', '/terrace propsal set up 3.jpg', '/terrace propsal set up 4.jpg', '/terrace propsal set up 5.jpg', '/terrace propsal set up 6.jpg', '/terrace-proposal.jpg', '/terrace.jpg']).map((img, i) => ({
      ...
      image: img,
      moreImages: ['/terrace propsal set up.jpg', '/terrace propsal set up 3.jpg', '/terrace propsal set up 4.jpg', '/terrace propsal set up 5.jpg', '/terrace propsal set up 6.jpg', '/terrace-proposal.jpg', '/terrace.jpg'].filter((x) => x !== img),
    ...
    ...((['/heart arch set up 1.jpg', '/heart arch set up 2.jpg', '/heart arch set up 3.jpg']).map((img, i) => ({
      ...
      image: img,
      moreImages: ['/heart arch set up 1.jpg', '/heart arch set up 2.jpg', '/heart arch set up 3.jpg'].filter((x) => x !== img),
    ...
    ...((['/candelight pathway 1.jpg', '/candelight pathway 2.jpg', '/candelight pathway 3.jpg', '/candelight pathway 4.jpg']).map((img, i) => ({
      ...
      image: img,
      moreImages: ['/candelight pathway 1.jpg', '/candelight pathway 2.jpg', '/candelight pathway 3.jpg', '/candelight pathway 4.jpg'].filter((x) => x !== img),
  ...
  'car boot surprises': [
    ...
    ...(['/car bot 1.jpg', '/car bot 2.jpg', '/car bot 3.jpg', '/car bot3.jpg'].map((img, i) => ({
      _id: `exp_boot_${i + 2}`,
      categoryId: 'cat_exp',
  ...
  'live eateries': [
    ...
    ...(([
      ['Instant Maggi Counter', 'Instant Maggi', '/instant maggi.jpg', 'Hot masala Maggi cooked live to order with veggies & cheese toppings.'],
      ['Live Chaat Counter', 'Chaat Counters', '/chat counter.jpg', 'Pani puri, bhel, sev puri & dahi chaat served fresh from a live counter.'],
      ['Fresh Fruit Salad Bar', 'Fruit Salad', '/fruit salad.jpg', 'Seasonal cut fruit bar with toppings, dry fruits & flavoured yoghurt.'],
      ['Live Pani Puri Stall', 'Live Pani Puri', '/pani puri.jpg', 'Crisp puris with 5 flavoured waters, served live by a dedicated stall artist.'],
      ['Ice Cream Flavours Cart', 'Ice Cream Flavours', '/ice cream.jpg', 'Scoop cart with 6 flavours, cones, cups & assorted sprinkles.'],
...
export const OccasionPage: React.FC<{
  ...
  const subcategories = useMemo(() => {
    ...
    if (normCat.includes('experience')) {
      return [
        { name: 'Cabana Setups', image: '/kkkk.jpg' },
        { name: 'Proposal Setup', image: '/tearce.jpg' },
        { name: 'Car Boot Surprises', image: '/car bot.jpg' },
        { name: 'Car & Bike Decoration', image: '/car dilver.jpg' },
      ];
    }
