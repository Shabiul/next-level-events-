...
export const AIPlannerPage: React.FC = () => {
  ...
  return (
    <>
      <SeoHead
        title="AI Event Planner & Concierge — The Decor Party Bangalore"
        description="Plan your celebration in seconds with AI. Personalized decor themes, balloon styling ideas, custom budgets, and instant booking for Bengaluru events."
        keywords={[
          'ai event planner bangalore',
          'ai party concierge',
