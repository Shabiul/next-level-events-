...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    gradient: 'linear-gradient(to right, rgba(56,25,50,0.85), rgba(56,25,50,0.4))',
    cta: 'Plan Your Celebration',
    ctaLink: '/explore',
  },
  {
    img: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=1600&auto=format&fit=crop&q=85',
    chip: 'GRAND PROPOSALS & ANNIVERSARIES',
    headline: 'Grand Proposals &\nMilestone Galas.',
    sub: '4-foot illuminated marquee letters, plush red carpets, and bespoke celebration backdrops.',
    gradient: 'linear-gradient(to right, rgba(56,25,50,0.85), rgba(56,25,50,0.4))',
    cta: 'Explore Proposals',
    ctaLink: '/explore?q=Proposal',
  },
  {
    img: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1600&auto=format&fit=crop&q=85',
    chip: 'ROMANTIC EXPERIENCES & CABANAS',
    headline: 'Beautiful Beginnings,\nBeautifully Celebrated.',
    sub: 'Intimate candlelit dining, sheer canopies, and fairy-tale florals curated for two.',
    gradient: 'linear-gradient(to right, rgba(56,25,50,0.85), rgba(56,25,50,0.4))',
    cta: 'Book Romantic Setup',
    ctaLink: '/explore?q=Romantic',
  },
  {
    img: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=1600&auto=format&fit=crop&q=85',
    chip: 'MILESTONE BIRTHDAYS',
    headline: 'Birthdays Made\nUnforgettable.',
    sub: 'Artisanal pastel balloon arches, personalised LED neon signage, and theme styling.',
    gradient: 'linear-gradient(to right, rgba(56,25,50,0.85), rgba(56,25,50,0.4))',
    cta: 'Explore Birthdays',
    ctaLink: '/explore?q=Birthday',
  },
];
