    ...
    <div className="w-full">
      ...
      <div className="mb-8 sm:mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div className="flex flex-col gap-2">
          <p className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.24em] text-[#381932] dark:text-[#381932]">
            <span className="eyebrow-line bg-[#381932] dark:bg-[#381932]" />
            Celebration Catalog
          </p>
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-[44px] font-normal uppercase tracking-tight text-[#381932] dark:text-[#FFF3E6] leading-[1.08]">
            {t?.categories_title || 'Explore Our Categories'}
          </h2>
          <p className="text-xs sm:text-sm md:text-[15px] font-light leading-relaxed text-[#381932] dark:text-[#FFF3E6] max-w-2xl">
        ...
        <a
          href="/explore"
          className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#381932] hover:text-[#381932] dark:text-[#381932] dark:hover:text-[#FFF3E6] hover:underline whitespace-nowrap self-start sm:self-auto transition-colors"
        >
