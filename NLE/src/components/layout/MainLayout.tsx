...
interface MainLayoutProps {
  ...
  onCartRemoveAddon?: (productId: string, addonIdOrName: string) => void;
  ...
  return (
    <>
      ...
      {hideShell ? (
        ...
        <div className="min-h-screen flex flex-col bg-[#FFF3E6] dark:bg-[#381932] text-[#381932] dark:text-[#FFF3E6] transition-colors duration-200">
          <Header
            auth={auth}
            t={t}
          ...
          {cartOpen && (
            <CartPage
              ...
              onRemoveAddon={onCartRemoveAddon}
      ...
      {!hideShell && (
        <>
          <ScrollProgressBar />
          <FloatingActionMenu onAssistantOpen={() => setAssistantPanelOpen(true)} />
          <BackToTopButton />
          <AssistantPanel
