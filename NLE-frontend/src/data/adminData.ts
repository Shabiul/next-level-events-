...
export let ADMIN_PRODUCTS: AdminProduct[] = [
  { _id: 'p1', name: 'Balloon Arch Birthday Decor', categoryId: 'cat_1', categoryName: 'Birthday Decorations', subcategory: '', price: 1299, originalPrice: 1850, description: 'Premium balloon arch setup with personalised decor at your location. 2-hour installation.', inclusions: [], addOns: [], image: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=400&q=80', moreImages: [], badge: 'Most Loved', badgeColor: 'purple', rating: 4.9, reviewCount: 2300, active: true, featured: true, createdAt: '2026-01-15', updatedAt: '2026-02-20' },
...
export let ADMIN_SLIDES: AdminSlide[] = [
  { _id: 'sl1', image: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=1400&q=85', chip: '🎊 Most Popular', headline: 'Birthday Decorations\nfor Every Style', subtext: 'Balloon arches, backdrops & more — done in 2 hours', gradient: 'linear-gradient(to right, rgba(56,25,50,.75), rgba(56,25,50,.1))', ctaText: 'Explore Birthdays', ctaLink: '#birthday', order: 1, active: true, createdAt: '2026-01-01', updatedAt: '2026-01-01' },
  { _id: 'sl2', image: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1400&q=85', chip: '🕯️ Trending Now', headline: 'Romantic Candlelight\nDinners in Bangalore', subtext: 'Private setup at your home or venue — from ₹2,499', gradient: 'linear-gradient(to right, rgba(56,25,50,.75), rgba(56,25,50,.1))', ctaText: 'Book a Dinner', ctaLink: '#dinners', order: 2, active: true, createdAt: '2026-01-01', updatedAt: '2026-01-01' },
  { _id: 'sl3', image: 'https://images.unsplash.com/photo-1464366400600-7168b9238cd48?w=1400&q=85', chip: '💍 Anniversary Special', headline: 'Surprise Your Partner\nWith a Dreamy Setup', subtext: 'Rose petals, fairy lights, balloons — we handle everything', gradient: 'linear-gradient(to right, rgba(56,25,50,.75), rgba(56,25,50,.1))', ctaText: 'Plan Anniversary', ctaLink: '#anniversary', order: 3, active: true, createdAt: '2026-01-01', updatedAt: '2026-01-01' },
  { _id: 'sl4', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1400&q=85', chip: '🎁 New Arrivals', headline: 'Surprise Explosion\nBoxes & Hampers', subtext: 'Personalised gifts delivered same day across Bangalore', gradient: 'linear-gradient(to right, rgba(56,25,50,.75), rgba(56,25,50,.1))', ctaText: 'Shop Gifts', ctaLink: '#gifts', order: 4, active: false, createdAt: '2026-01-01', updatedAt: '2026-01-01' },
  { _id: 'sl5', image: 'https://images.unsplash.com/photo-1602631985686-1bb0e6a8696e?w=1400&q=85', chip: '🌸 Festival Season', headline: 'Festive Decorations\nfor Every Occasion', subtext: 'Diwali, Navratri, Christmas & more — book now', gradient: 'linear-gradient(to right, rgba(56,25,50,.75), rgba(56,25,50,.1))', ctaText: 'View Festivals', ctaLink: '#festivals', order: 5, active: true, createdAt: '2026-01-01', updatedAt: '2026-01-01' },
];
