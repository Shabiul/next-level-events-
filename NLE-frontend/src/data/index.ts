...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    gradient: 'linear-gradient(to right, rgba(52, 32, 60, 0.85), rgba(72, 50, 80, 0.4))',
  ...
  },
  {
    ...
    sub: 'Artisanal pastel balloon arches, personalized LED neon signage, and theme styling.',
    gradient: 'linear-gradient(to right, rgba(52, 32, 60, 0.85), rgba(72, 50, 80, 0.4))',
