            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
              ...
              <div className="lg:col-span-5 relative w-full aspect-[4/3] sm:aspect-[16/11] lg:aspect-auto lg:h-[400px] rounded-2xl overflow-hidden bg-[#24132B] border border-[#8F6FC4]/20 shadow-xl">
                ...
                <div className="absolute bottom-4 right-4 z-10">
                  <span className="inline-flex items-center rounded-full bg-black/65 border border-white/20 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-[#FAF8F5] backdrop-blur-md">
                    BENGALURU
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 flex flex-col justify-between h-full">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <h3 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold uppercase text-[#FAF8F5] leading-tight mb-4">
                      {activeItem.title}
                    </h3>
