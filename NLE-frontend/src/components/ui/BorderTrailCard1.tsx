    ...
    <div className="pointer-events-none absolute inset-0 rounded-[inherit] overflow-hidden">
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            '0px 0px 60px 30px rgba(255, 255, 255, 0.5), 0 0 100px 60px rgba(0, 0, 0, 0.5), 0 0 140px 90px rgba(0, 0, 0, 0.5)',
          ...style,
        }}
        animate={{
...
export function BorderTrailCard1({
  ...
  return (
    <div
      className={`relative flex h-[200px] w-[300px] flex-col items-center justify-center rounded-md bg-zinc-200 px-5 py-2 dark:bg-zinc-800 ${className}`}
    >
      ...
      >
        {/* Line 1: h-1 w-4 rounded-[4px] bg-zinc-600 */}
        <div className="h-1 w-4 rounded-[4px] bg-zinc-600" />

        {/* Line 2: h-1 w-10 rounded-[4px] bg-zinc-600 */}
        <div className="h-1 w-10 rounded-[4px] bg-zinc-600" />

        {/* Line 3: h-1 w-12 rounded-[4px] bg-zinc-600 */}
        <div className="h-1 w-12 rounded-[4px] bg-zinc-600" />

        {/* Line 4: h-1 w-12 rounded-[4px] bg-zinc-600 */}
        <div className="h-1 w-12 rounded-[4px] bg-zinc-600" />

        {/* Line 5: h-1 w-12 rounded-[4px] bg-zinc-600 */}
        <div className="h-1 w-12 rounded-[4px] bg-zinc-600" />
