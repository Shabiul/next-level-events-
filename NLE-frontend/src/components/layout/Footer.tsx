  ...
  return (
    <footer id="footer" className="relative bg-[#201024] text-[#FAF8F5] border-t border-white/10 overflow-hidden scroll-mt-24 sm:scroll-mt-28">
          ...
          <div className="lg:col-span-3 xl:col-span-3 flex flex-col justify-between">
            <div>
              <div className="mb-3.5 flex items-center gap-2.5">
                ...
                />
                <span className="font-serif text-lg font-bold tracking-[0.06em] uppercase text-[#FAF8F5]">
                  TheDecorParty
                </span>
              </div>

              <p className="mb-5 text-xs sm:text-[13px] font-light leading-relaxed text-[#FAF8F5]/70 max-w-xs">
                {t?.footer_copy ||
            ...
            <div className="flex items-center gap-2.5 pt-1">
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/15 bg-white/5 text-[#FAF8F5]/80 hover:bg-white/15 hover:text-[#FAF8F5] transition-all hover:scale-105"
              >
                <FacebookIcon />
              </a>
              <a
      ...
      <div className="border-t border-white/10 bg-[#190C1C] px-5 sm:px-8 lg:px-12 py-3.5">
        <div className="mx-auto flex max-w-[1720px] flex-col sm:flex-row items-center justify-between gap-2.5 text-center text-[11px] text-[#FAF8F5]/60">
