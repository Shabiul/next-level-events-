    ...
    <div className="w-full">
      ...
      <div className="mb-8 sm:mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div className="flex flex-col gap-2">
          <p className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.24em] text-[#725D75] dark:text-[#A78A9F]">
          ...
          <p className="text-xs sm:text-sm md:text-[15px] font-light leading-relaxed text-[#725D75] dark:text-[#C8B5C3] max-w-2xl">
        ...
        <a
          href="/explore"
          className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#34203C] hover:text-[#725D75] dark:text-[#C9BEAB] dark:hover:text-[#FAF8F5] hover:underline whitespace-nowrap self-start sm:self-auto transition-colors"
        >
