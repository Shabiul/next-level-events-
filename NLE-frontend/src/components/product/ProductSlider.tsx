  ...
  return (
    <div className={cn('py-4 sm:py-6 w-full', className)}>
      ...
      <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-3">
        <div>
          <h3 className="font-serif text-lg sm:text-xl md:text-2xl font-bold uppercase text-[#381932] dark:text-[#FFF3E6] tracking-[0.04em] leading-snug">
            {title}
          </h3>
          <p className="text-xs sm:text-[13px] font-normal text-[#381932] dark:text-[#FFF3E6] tracking-normal mt-0.5">
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-[#381932]/30 bg-[#FFF3E6] text-[#381932] hover:bg-[#FFF3E6] hover:border-[#381932] dark:bg-[#381932] dark:border-[#381932] dark:text-[#FFF3E6] transition-all active:scale-95 cursor-pointer shadow-xs"
