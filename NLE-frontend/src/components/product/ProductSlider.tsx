  ...
  return (
    <div className={cn('py-4 sm:py-6 w-full', className)}>
      ...
      <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-3">
        <div>
          <h3 className="font-serif text-lg sm:text-xl md:text-2xl font-bold uppercase text-[#34203C] dark:text-[#FAF8F5] tracking-[0.04em] leading-snug">
            {title}
          </h3>
          <p className="text-xs sm:text-[13px] font-normal text-[#725D75] dark:text-[#C8B5C3] tracking-normal mt-0.5">
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-[#DDD5C7] bg-[#FAF8F5] text-[#34203C] hover:bg-[#F5EFE6] hover:border-[#34203C] dark:bg-[#2D1C34] dark:border-[#483250] dark:text-[#FAF8F5] transition-all active:scale-95 cursor-pointer shadow-xs"
