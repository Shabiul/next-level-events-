      ...
      <div className="min-h-screen bg-[#FAF8F5] dark:bg-[#1B101F] text-[#34203C] dark:text-[#FAF8F5] transition-colors pb-24">
        <div className="mx-auto max-w-[1720px] px-4 py-6 sm:px-6 md:px-8 lg:px-12 animate-fade-in">
          ...
          <div className="mb-6 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 text-xs text-[#725D75] dark:text-[#A78A9F] font-medium tracking-wide">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-[32px] sm:rounded-[40px] bg-[#120A16] text-[#FAF8F5] p-8 sm:p-12 lg:p-16 shadow-2xl border border-[#A78A9F]/20 mb-12 min-h-[380px] md:min-h-[460px] flex items-center"
          >
            ...
            <div className="relative z-20 max-w-xl text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#482E54]/60 border border-[#A78A9F]/30 text-[#C9BEAB] text-[11px] sm:text-xs font-bold uppercase tracking-[0.2em] shadow-md mb-5 backdrop-blur-xs">
              ...
              <p className="text-xs sm:text-sm md:text-base text-[#F6EFF4]/90 font-light leading-relaxed max-w-lg mb-8">
              ...
              <button
                ...
                className="inline-flex items-center gap-2.5 rounded-full px-8 py-3.5 text-xs font-extrabold uppercase tracking-wider text-[#34203C] bg-[#E5D7C2] hover:bg-white shadow-xl hover:scale-102 transition-all cursor-pointer"
              >
          ...
          >
            <div className="text-center max-w-2xl mx-auto mb-8">
              <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-[#725D75] dark:text-[#A78A9F] mb-2">
                PREMIUM CELEBRATION LIVING
              </p>
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-normal text-[#34203C] dark:text-[#FAF8F5] tracking-tight uppercase leading-tight">
                Our Curated Theme Setups
              </h2>
              <p className="text-xs sm:text-sm text-[#725D75] dark:text-[#C8B5C3] font-light mt-2">
          ...
          >
            <div className="text-center mb-8">
              <p className="text-[11px] font-extrabold uppercase tracking-[0.25em] text-[#725D75] dark:text-[#A78A9F] mb-2">
                — {decodedCategory.toUpperCase()} FAQS —
              </p>
              <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-semibold text-[#34203C] dark:text-[#FAF8F5] tracking-tight">
                {decodedCategory} Frequently Asked Questions
              </h2>
              <p className="mt-2 text-xs sm:text-sm text-[#725D75] dark:text-[#C8B5C3] font-light max-w-xl mx-auto">
            ...
            <div className="rounded-2xl sm:rounded-3xl border border-[#DDD5C7] dark:border-[#483250] bg-white dark:bg-[#201325] shadow-md overflow-hidden divide-y divide-[#DDD5C7]/60 dark:divide-[#483250]/60">
              {currentThemeFaqs.map((faq, index) => {
                ...
                return (
                  <div key={index} className="transition-colors">
                    ...
                    >
                      <span className="font-serif text-base sm:text-lg font-bold text-[#34203C] dark:text-[#FAF8F5]">
                        {faq.question}
                      </span>
                      <div className="w-8 h-8 rounded-full bg-[#FAF8F5] dark:bg-[#34203C] border border-[#DDD5C7] dark:border-[#483250] flex items-center justify-center text-[#34203C] dark:text-[#C9BEAB] shrink-0 font-mono text-sm font-bold">
                        {isOpen ? '−' : '+'}
                      </div>
                    </button>

                    {isOpen && (
                      <div className="px-5 pb-6 sm:px-6 sm:pb-6 text-xs sm:text-sm text-[#725D75] dark:text-[#C8B5C3] font-light leading-relaxed animate-fade-in">
                        {faq.answer}
                      </div>
                    )}
                  </div>
