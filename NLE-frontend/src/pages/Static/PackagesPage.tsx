    ...
    <>
      ...
      <div className="flex flex-col w-full bg-[#FAF8F5] dark:bg-[#1B101F] text-[#34203C] dark:text-[#FAF8F5] font-sans antialiased transition-colors min-h-screen">
        ...
        >
          ...
          <div className="absolute top-28 right-1/4 w-96 h-96 rounded-full bg-[#C9BEAB]/12 blur-3xl pointer-events-none -z-10" />
          ...
          <div className="max-w-4xl mx-auto flex flex-col items-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#34203C]/06 dark:bg-white/10 border border-[#34203C]/10 dark:border-white/15 text-xs font-bold uppercase tracking-[0.22em] text-[#725D75] dark:text-[#C9BEAB] mb-4 sm:mb-5"
            >
            ...
            <motion.h1
              ...
              className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-normal tracking-tight text-[#34203C] dark:text-[#FAF8F5] leading-[1.12] mb-4 uppercase"
            >
              DETAILED SERVICE <span className="font-serif italic text-[#725D75] dark:text-[#C9BEAB] lowercase">Inclusions</span> &amp; TIERS
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-xs sm:text-sm md:text-base font-light leading-relaxed text-[#725D75] dark:text-[#C8B5C3] max-w-2xl mb-8"
            >
              ...
              return (
                <button
                  ...
                  className={`relative shrink-0 rounded-full px-4 sm:px-5 py-2.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 cursor-pointer flex items-center gap-1.5 ${
                    isActive
                      ? 'bg-[#34203C] text-[#FAF8F5] dark:bg-[#C9BEAB] dark:text-[#25172C] shadow-md scale-102'
              ...
              return (
                <motion.div
                  ...
                  className={`group relative flex flex-col justify-between rounded-[28px] sm:rounded-[32px] p-6 sm:p-7 shadow-xl transition-all duration-300 hover:-translate-y-1.5 ${
                    pkg.popular
                      ? 'bg-gradient-to-b from-[#2B142F] to-[#1D0E20] border-2 border-[#C9BEAB]/60 shadow-[0_20px_50px_rgba(52,32,60,0.25)]'
                      : 'bg-gradient-to-b from-[#26112A] to-[#190C1C] border border-[#A78A9F]/20 hover:border-[#C9BEAB]/40'
                  } text-[#FAF8F5]`}
                >
                  ...
                  <div>
                    <div className="rounded-2xl p-4 sm:p-5 mb-5 border border-[#A78A9F]/25 bg-[#34203C]/85 shadow-inner backdrop-blur-md transition-all duration-300 group-hover:border-[#C9BEAB]/40 group-hover:bg-[#483250]/90">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {pkg.popular && (
                          <span className="rounded-full border border-[#C9BEAB]/50 bg-[#C9BEAB] text-[#25172C] px-2.5 py-0.5 text-[9px] font-extrabold uppercase tracking-wider shadow-xs flex-shrink-0">
                            Popular Choice
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex items-baseline justify-between mt-3 mb-4">
                        ...
                        <span className="text-[10px] text-[#DDD5C7]/60 italic">
                          / complete setup
                        </span>
                      </div>
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1.5 w-full rounded-full bg-[#C9BEAB] hover:bg-[#FAF8F5] text-[#34203C] py-2.5 px-4 text-xs font-bold uppercase tracking-wider shadow-md transition-all duration-300 hover:scale-102 active:scale-95 cursor-pointer"
                      >
                    ...
                    {/* Package Title */}
                    <h3 className="font-serif text-base sm:text-lg font-bold uppercase tracking-[0.03em] leading-snug text-[#FAF8F5] mb-2 group-hover:text-[#C9BEAB] transition-colors">
                      {pkg.title}
                    </h3>
                    ...
                    {/* Quick Specs Badges */}
                    <div className="grid grid-cols-2 gap-2 mb-5 p-3 rounded-xl bg-white/05 border border-white/10 text-[10px] text-[#DDD5C7]">
                      <div className="flex items-center gap-1.5">
                        <Clock size={12} className="text-[#C9BEAB] shrink-0" />
                        <span>{pkg.specs.duration}</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <Shield size={12} className="text-[#C9BEAB] shrink-0" />
                  ...
                  <div className="pt-4 border-t border-white/10 mt-auto">
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1.5 w-full text-[11px] font-semibold text-[#DDD5C7] hover:text-emerald-400 transition-colors cursor-pointer py-1"
                    >
        ...
        >
          <div className="rounded-[32px] sm:rounded-[40px] border border-[#DDD5C7] dark:border-[#483250] bg-white/80 dark:bg-[#201325]/90 p-6 sm:p-10 lg:p-12 shadow-xl backdrop-blur-md">
            <div className="max-w-3xl mb-8">
              <span className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-[0.2em] text-[#725D75] dark:text-[#C9BEAB] mb-2">
                <Zap size={13} className="text-[#A78A9F]" />
                TIER COMPARISON SPECIFICATIONS
              </span>
              <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-normal uppercase tracking-tight text-[#34203C] dark:text-[#FAF8F5]">
                What Makes Every Tier Distinct
              </h2>
              <p className="text-xs sm:text-sm text-[#725D75] dark:text-[#C8B5C3] font-light mt-2 leading-relaxed">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs sm:text-sm border-collapse">
                <thead>
                  <tr className="border-b border-[#DDD5C7] dark:border-[#483250] text-[#34203C] dark:text-[#FAF8F5] uppercase tracking-wider text-[11px] font-bold">
                    <th className="py-4 pr-4">Service Feature</th>
                    <th className="py-4 px-4">Standard Balloon Arch (₹2,499)</th>
                    <th className="py-4 px-4 bg-[#34203C]/04 dark:bg-white/04 rounded-t-xl">Cabana &amp; Rooftop (₹3,499)</th>
                    <th className="py-4 pl-4">Bespoke Grand Stage (₹7,999)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#DDD5C7]/60 dark:divide-[#483250]/60 text-[#725D75] dark:text-[#C8B5C3] font-light">
                  <tr>
                    <td className="py-4 pr-4 font-medium text-[#34203C] dark:text-[#FAF8F5]">Backdrop Structure</td>
                    <td className="py-4 px-4">6ft Metallic Ring Frame</td>
                    <td className="py-4 px-4 bg-[#34203C]/04 dark:bg-white/04">Sheer Chiffon Canopy Cabana</td>
                    <td className="py-4 pl-4">12ft Grand Stage with Acrylic Plinths</td>
                  </tr>
                  <tr>
                    <td className="py-4 pr-4 font-medium text-[#34203C] dark:text-[#FAF8F5]">Neon &amp; Signage</td>
                    <td className="py-4 px-4">LED Neon Sign Included</td>
                    <td className="py-4 px-4 bg-[#34203C]/04 dark:bg-white/04">Customized Romantic Message Board</td>
                    <td className="py-4 pl-4">3D Custom Acrylic Name / Monogram</td>
                  </tr>
                  <tr>
                    <td className="py-4 pr-4 font-medium text-[#34203C] dark:text-[#FAF8F5]">Lighting Elements</td>
                    <td className="py-4 px-4">Ambient String Lights</td>
                    <td className="py-4 px-4 bg-[#34203C]/04 dark:bg-white/04">50+ Smokeless LED Pillar Candles</td>
                    <td className="py-4 pl-4">Studio Focus Spotlights + Fairylights</td>
                  </tr>
                  <tr>
                    <td className="py-4 pr-4 font-medium text-[#34203C] dark:text-[#FAF8F5]">On-Site Stylists</td>
                    <td className="py-4 px-4">2 Certified Decorators</td>
                    <td className="py-4 px-4 bg-[#34203C]/04 dark:bg-white/04">2 Master Stylists</td>
                    <td className="py-4 pl-4">4-Member Crew + Dedicated Event Lead</td>
                  </tr>
                  <tr>
                    <td className="py-4 pr-4 font-medium text-[#34203C] dark:text-[#FAF8F5]">Setup Time Guarantee</td>
                    <td className="py-4 px-4">45-60 Minutes</td>
                    <td className="py-4 px-4 bg-[#34203C]/04 dark:bg-white/04">75-90 Minutes</td>
                    <td className="py-4 pl-4">2.5 Hours Complete Staging</td>
                  </tr>
                  <tr>
                    <td className="py-4 pr-4 font-medium text-[#34203C] dark:text-[#FAF8F5]">Post-Event Teardown</td>
                    <td className="py-4 px-4">
                      <span className="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400 font-semibold">
                        <Check size={14} /> 100% Clean Teardown
                      </span>
                    </td>
                    <td className="py-4 px-4 bg-[#34203C]/04 dark:bg-white/04">
                      <span className="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400 font-semibold">
                        <Check size={14} /> 100% Clean Teardown
                      </span>
                    </td>
