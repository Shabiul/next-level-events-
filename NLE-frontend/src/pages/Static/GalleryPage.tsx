...
function buildBaseCollection(): GalleryImageItem[] {
  ...
  const out: GalleryImageItem[] = [
    { id: 'gal-brand-1', title: 'Signature Purple Milestone Suite', category: 'CUSTOM THEMES', image: '/about-purple-decor.png', tag: 'Signature Milestone' },
    { id: 'gal-brand-2', title: 'Bespoke Celebration Atmosphere', category: 'CUSTOM THEMES', image: '/about-aesthetic.png', tag: 'Atmosphere Styling' },
    { id: 'gal-brand-3', title: 'Luxe Editorial Celebration Backdrop', category: 'CUSTOM THEMES', image: '/about-purple-banner.png', tag: 'Editorial Suite' },
  ];
